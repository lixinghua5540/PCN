...
_base_ = [
    ...
    '../_base_/models/deeplabv3plus_r50-d8_org.py',
    # GTA->Cityscapes Data Loading
    '../_base_/datasets/pots_irrg2vaih_irrg_new.py',
    # Basic UDA Self-Training
    '../_base_/uda/source_only.py',
    # AdamW Optimizer
    '../_base_/schedules/adamw_40k.py',
]
expr_name='source_only_pots_irrg2vaih_irrg_deeplab'
