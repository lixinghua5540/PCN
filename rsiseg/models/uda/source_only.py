...
@UDA.register_module()
class Source_Only(UDADecorator):

    def __init__(self, **cfg):
        super(Source_Only, self).__init__(**cfg)
        self.local_iter = 0
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg, target_img, img_copy,target_img_strong_aug,target_img_copy,
                      target_img_metas):
