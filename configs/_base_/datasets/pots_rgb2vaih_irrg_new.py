...
source_pipeline = [
    ...
    dict(type='Resize', img_scale=(576, 576), ratio_range=(0.5, 2.0)),# fix the scale based on ratio range
...
target_pipeline = [
    ...
    dict(type='Normalize', **img_norm_cfg),
    dict(type='DefaultFormatBundle'),
    dict(type='Collect', keys=['img', 'img_copy','img_strong_aug']),
]
...
data_root_pots = '/data/mjh/Bi_Seg/PCN/Datasets/P_V/Potsdam_RGB_1024_mmlab'
